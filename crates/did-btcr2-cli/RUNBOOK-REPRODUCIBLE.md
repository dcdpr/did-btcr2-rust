# did-btcr2-cli RUNBOOK (reproducible / fixed-key) — full DID lifecycle on mutinynet

> **Which runbook do you want?**
> - **[RUNBOOK.md](./RUNBOOK.md)** — a **live demo** with a *freshly generated*
>   key you control. Use this to actually broadcast on mutinynet and show real,
>   owned txids (e.g. an impromptu demo).
> - **This file** — a **byte-for-byte reproducible** walkthrough pinned to one
>   fixed, PUBLICLY-KNOWN demo key. Its read-only steps reproduce exactly; its
>   write steps are illustrative `SAMPLE`s (nothing here is broadcast). Use this
>   as a stable reference, not for a live demo.
